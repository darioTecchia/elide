package elide.model.salepolicy;
...
public class SalePolicy implements Serializable, Cloneable {
  ...
  public String toString() {
    return this.getClass().getSimpleName() + "{" + "actived: " + this.actived + "discountPercentage: "
        + this.discountPercentage + "kind: " + this.kind + "}";
  }
  ...
  public boolean equals(Object anotherObject) {
    ...
    return this.actived == other.actived && this.discountPercentage == other.discountPercentage
