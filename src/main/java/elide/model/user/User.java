package elide.model.user;

import java.io.Serializable;
import java.util.ArrayList;

import elide.model.ticket.Ticket;
import elide.model.match.Match;
import elide.model.seat.Seat;
import elide.model.stadium.Stadium;
...
public class User implements Serializable, Cloneable {
  ...
  public enum ClientKindEnum {
    ...
    NORMAL(0), ADMIN(1), KIDS(50), ELDERLY(15), STUDENT(25);
  ...
  public String toString() {
    return this.getClass().getSimpleName() + "{" + "admin: " + this.admin + "kind: " + this.kind + "name: " + this.name
        + "password" + this.password + "preOrderTickets: " + this.preOrderedTickets + "purchasedTickets: "
  ...
  public boolean equals(Object anotherObject) {
    ...
    return this.admin == other.admin && this.kind.equals(other.kind) && this.name.equals(other.name)
        && this.password.equals(other.password) && this.preOrderedTickets.equals(other.preOrderedTickets)
